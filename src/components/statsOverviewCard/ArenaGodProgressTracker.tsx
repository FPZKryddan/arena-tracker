...
const ArenaGodProgressTracker = ({
  ...
  const title = hasArenaGod ? "True Arena Mastery" : "Arena God";

  return (
    <div className="inline-flex w-fit items-center gap-2 rounded-full border border-border bg-surface-elevated/55 px-2 py-1 text-fg">
      <div
